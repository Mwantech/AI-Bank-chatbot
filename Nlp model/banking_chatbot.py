...
class BankingChatbot:
    def __init__(self, intents_file: str = 'intents.json'):
        ...
        try:
            ...
            # Initialize vectorizer and prepare training data
            ...
            # Initialize context and user management
    ...
    def load_intents(self, intents_file: str) -> None:
        ...
        try:
            ...
            # Create the full path to the intents file
            file_path = os.path.join(current_dir, intents_file)
